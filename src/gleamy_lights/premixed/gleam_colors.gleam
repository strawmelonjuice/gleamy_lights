...
/// ### "Faff pink" text
/// Hex: `#ffaff3`
pub fn text_faff_pink_gl(msg: String) -> String {
  msg
  |> by_hexcolor("#ffaff3")
}
...
/// ### "White" text
/// Hex: `#fefefc`
pub fn text_white_gl(msg: String) -> String {
  msg
  |> by_hexcolor("#fefefc")
}
...
/// ### "White" background
/// Hex: `#fefefc`
pub fn bg_white_gl(msg: String) -> String {
  msg
...
/// ### "Charcoal" text
/// Hex: `#2f2f2f`
pub fn text_charcoal_gl(msg: String) -> String {
  msg
  |> by_hexcolor("#2f2f2f")
}
...
/// ### "Charcoal" background
/// Hex: `#2f2f2f`
pub fn bg_charcoal_gl(msg: String) -> String {
  msg
...
/// ### "Black" text
/// Hex: `#1e1e1e`
pub fn text_black_gl(msg: String) -> String {
  msg
  |> by_hexcolor("#1e1e1e")
}
...
/// ### "Black" background
/// Hex: `#1e1e1e`
pub fn bg_black_gl(msg: String) -> String {
  msg
...
/// ### "Blacker" text
/// Hex: `#151515`
pub fn text_blacker_gl(msg: String) -> String {
  msg
  |> by_hexcolor("#151515")
}
...
/// ### "Blacker" background
/// Hex: `#151515`
pub fn bg_blacker_gl(msg: String) -> String {
  msg
